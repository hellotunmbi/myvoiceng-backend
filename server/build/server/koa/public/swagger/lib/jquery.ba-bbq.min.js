...
(function ($, p) {
  ...
  };c.noEscape(",/");$.deparam = l = function (I, F) {
    var H = {},
  ...
  }$.fn[A] = B(s, A);$.fn[D] = B(s, D);b.pushState = q = function (I, F) {
    if (E(I) && /^#/.test(I) && F === i) {
      F = 2;
    }var H = I !== i,
  ...
  var j,
    ...
    var m = {},
      ...
      o = q = function (s) {
        ...
        n = $('<iframe src="javascript:0"/>').hide().insertAfter("body")[0].contentWindow;q = function () {
