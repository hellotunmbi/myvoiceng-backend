  ...
  function G(a) {
    ...
    return p.event.special.hover ? a : a.replace(X, "mouseenter$1 mouseleave$1");
      ...
      if (!f || f.nodeType !== 3 && f.nodeType !== 8) {
        ...
        }for (j = 0; j < q.length && !c.isPropagationStopped(); j++) k = q[j][0], c.type = q[j][1], o = (p._data(k, "events") || {})[c.type] && p._data(k, "handle"), o && o.apply(k, d), o = m && k[m], o && p.acceptData(k) && o.apply(k, d) === !1 && c.preventDefault();return (c.type = s, !g && !c.isDefaultPrevented() && (!n._default || n._default.apply(f.ownerDocument, d) === !1) && (s !== "click" || !p.nodeName(f, "a")) && p.acceptData(f) && m && f[s] && (s !== "focus" && s !== "blur" || c.target.offsetWidth !== 0) && !p.isWindow(f) && (l = f[m], l && (f[m] = null), p.event.triggered = s, f[s](), p.event.triggered = b, l && (f[m] = l)), c.result);
      }return;
      ...
      c = p.event.fix(c || a.event);var d,
        ...
        g = p(this), g.context = this;for (f = c.target; f != this; f = f.parentNode || this) if (f.disabled !== !0 || c.type !== "click") {
          i = {}, k = [], g[0] = f;for (d = 0; d < q; d++) l = o[d], m = l.selector, i[m] === b && (i[m] = g.is(m)), i[m] && k.push(l);k.length && u.push({ elem: f, matches: k });
        }
    ...
    function bd(a, b, c, d) {
      ...
      var d,
        ...
        g.push(d = []), o && (e = " " + e);while (e) {
          k = !1;if (j = B.exec(e)) e = e.slice(j[0].length), k = d.push({ part: j.pop().replace(A, " "), captures: j });for (f in n) (j = L[f].exec(e)) && (!m[f] || (j = m[f](j, b, c))) && (e = e.slice(j.shift().length), k = d.push({ part: f, captures: j }));if (!k) break;
        }
      }return (k || Z.error(a), g);
    }function bh(a, b, e) {
      var f = b.dir,
          g = m++;return (a || (a = function (a) {
        return a === e;
        ...
        var h,
            i = g + "." + d,
            j = i + "." + c;while (b = b[f]) if (b.nodeType === 1) {
      ...
      c = c || [], b = b || h;var e,
        ...
        $ = Z.selectors = { cacheLength: 50, match: L, order: ["ID", "TAG"], attrHandle: {}, createPseudo: Q, find: { ID: g ? function (a, b, c) {
          ...
          if (typeof c.getElementById !== j && !d) {
            var e = c.getElementById(a);return e ? e.id === a || typeof e.getAttributeNode !== j && e.getAttributeNode("id").value === a ? [e] : b : [];
          }
        }, TAG: W ? function (a, b) {
          ...
          return (a = a.replace(K, ""), function (b) {
            var c = typeof b.getAttributeNode !== j && b.getAttributeNode("id");return c && c.value === a;
          });
        }, TAG: function TAG(a) {
          return a === "*" ? function () {
            return !0;
    ...
    var a, b;p.uaMatch = function (a) {
      ...
      if (!a || a.nodeType === 3 || a.nodeType === 8 || !a.style) return;var f,
          ...
          h,
          i = p.camelCase(c),
          j = a.style;c = p.cssProps[i] || (p.cssProps[i] = bX(j, i)), h = p.cssHooks[c] || p.cssHooks[i];if (d === b) return h && "get" in h && (f = h.get(a, !1, e)) !== b ? f : j[c];g = typeof d, g === "string" && (f = bQ.exec(d)) && (d = (f[1] + 1) * f[2] + parseFloat(p.css(a, c)), g = "number");if (d == null || g === "number" && isNaN(d)) return;g === "number" && !p.cssNumber[i] && (d += "px");if (!h || !("set" in h) || (d = h.set(a, d, e)) !== b) try {
        j[c] = d;
      } catch (k) {}
    ...
    if (typeof a != "string" && ct) return ct.apply(this, arguments);if (!this.length) return this;var e,
        ...
        g,
        h = this,
        i = a.indexOf(" ");return (i >= 0 && (e = a.slice(i, a.length), a = a.slice(0, i)), p.isFunction(c) ? (d = c, c = b) : typeof c == "object" && (f = "POST"), p.ajax({ url: a, type: f, dataType: "html", data: c, complete: function complete(a, b) {
    ...
    p[c] = function (a, d, e, f) {
      ...
      function y(a, c, f, i) {
        var k,
          ...
          var c;if (v === 2) {
            if (!f) {
              f = {};while (c = cl.exec(e)) f[c[1].toLowerCase()] = c[2];
            }c = f[a.toLowerCase()];
          }return c === b ? null : c;
        ...
        w = "abort";for (k in { success: 1, error: 1, complete: 1 }) x[k](l[k]);g = cz(cv, l, c, x);if (!g) y(-1, "No Transport");else {
    ...
    if (!c.crossDomain || p.support.cors) {
      var d;return { send: function send(e, f) {
          var g,
              h,
            ...
            var h, j, k, l, m;try {
              if (d && (e || i.readyState === 4)) {
                d = b, g && (i.onreadystatechange = p.noop, cI && delete cH[g]);if (e) i.readyState !== 4 && i.abort();else {
