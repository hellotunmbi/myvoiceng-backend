...
(function () {
  ...
  var verifyMatch = function verifyMatch(open, close) {
...
(function (Compiler, JavaScriptCompiler) {
  ...
  Compiler.prototype = {
    ...
    program: function program(_program) {
      var statements = _program.statements,
          statement;
      this.opcodes = [];
    ...
    simpleMustache: function simpleMustache(mustache, program, inverse) {
      var id = mustache.id;
  ...
  JavaScriptCompiler.prototype = {
    ...
    nextOpcode: function nextOpcode() {
    ...
    lookupData: function lookupData(id) {
    ...
    invokeAmbiguous: function invokeAmbiguous(name) {
      this.context.aliases.functionType = '"function"';
    ...
    nextStack: function nextStack(skipCompileStack) {
    ...
    setupHelper: function setupHelper(paramSize, name) {
      var params = [];
    ...
    // to fill in
    setupParams: function setupParams(paramSize, params) {
      var options = [],
          contexts = [],
          param,
          inverse,
